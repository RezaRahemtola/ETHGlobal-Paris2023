					...
					<div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
						<div className="mb-12 max-w-[360px] lg:mb-16">
							<Link href="/" className="mb-8 inline-block">
								<Image src="/images/logo/logo.png" alt="logo" className="w-full" width={140} height={30} />
							</Link>
							<p className="mb-3 text-base font-medium leading-relaxed text-body-color">
								Composable chatrooms super-charged according to your needs.
							</p>
							<p className="mb-9 text-base font-medium leading-relaxed text-body-color">Made by the PoC team.</p>
							<div className="flex items-center">
								...
								<a
									href="https://twitter.com/PoCInnovation"
									target="_blank"
									aria-label="social-link"
									className="mr-6 text-[#CED3F6] hover:text-primary"
								>
								...
								<a
									href="https://www.youtube.com/@PoCInnovation"
									target="_blank"
									aria-label="social-link"
									className="mr-6 text-[#CED3F6] hover:text-primary"
								>
